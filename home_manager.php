...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="home_manager.php">SOE<span class="display"></span></a></h1>
...
<!--Header-->
			...
			<ul class="cd-radial-slider" data-radius1="60" data-radius2="1364" data-centerx1="110" data-centerx2="1290">
                ...
                <h2 style="background-color:#e6ddc5;">Hostel Management </h2>
								<h3 style="background-color:#e6ddc5;"> System </h3>
				...
				<li class="next-slide">
					...
					<div class="cd-radial-slider-content text-center">
						<div class="wrapper">
							<div class="text-center">
								<h3 style="background-color:#e6ddc5;">Rooms </h3>
				...
				<li>
					...
					<div class="cd-radial-slider-content text-center">
						<div class="wrapper">
							<div class="text-center">
								<h3 style="background-color:#e6ddc5;">Hostels </h3>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://soe.cusat.ac.in" target="_blank">SOE <span class="display"> CUSAT</span></a>
		</div>
